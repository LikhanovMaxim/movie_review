...
def run_my():
    ...
    train_x = matrix[25:175]
    # train_y = stars[size_tests_data:]
    train_y = stars[25:175]
    # test_x = matrix[:size_tests_data]
    test_x = np.concatenate((matrix[0:25], matrix[175:200]))
    # test_y = stars[:size_tests_data]
    test_y = np.concatenate((stars[0:25], stars[175:200]))
